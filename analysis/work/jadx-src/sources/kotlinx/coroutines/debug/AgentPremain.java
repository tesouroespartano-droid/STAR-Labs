...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM3604constructorimpl = Result.m3604constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM3604constructorimpl = Result.m3604constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m3610isFailureimpl(objM3604constructorimpl) ? null : objM3604constructorimpl);

...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM5143trySendImplMj0NB7M = conflatedBufferedChannel.m5143trySendImplMj0NB7M(e, true);
        if (objM5143trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m5128exceptionOrNullimpl(objM5143trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM5143trySendImplMj0NB7M = conflatedBufferedChannel.m5143trySendImplMj0NB7M(e, true);
        if (!(objM5143trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo5109trySendJP2dKIU(E element) {
        return m5143trySendImplMj0NB7M(element, false);
    }

    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m5143trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m5142trySendDropLatestMj0NB7M(element, isSendOp) : m5118trySendDropOldestJP2dKIU(element);
    }

    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m5142trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo5109trySendJP2dKIU = super.mo5109trySendJP2dKIU(element);
        if (ChannelResult.m5134isSuccessimpl(objMo5109trySendJP2dKIU) || ChannelResult.m5132isClosedimpl(objMo5109trySendJP2dKIU)) {
            return objMo5109trySendJP2dKIU;
        }
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo5109trySendJP2dKIU = mo5109trySendJP2dKIU(element);
        if (!(objMo5109trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo5109trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m5128exceptionOrNullimpl(objMo5109trySendJP2dKIU);

...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
        ...
        try {
            ...
            if (!isClosedForSend() || this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                if (this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                    subscriberConflated.mo5109trySendJP2dKIU(getValue());
                }
    ...
    public Object mo5109trySendJP2dKIU(E element) {
        ...
        try {
            ...
            if (!(list instanceof Collection) || !list.isEmpty()) {
                ...
                while (it.hasNext()) {
                    if (((BufferedChannel) it.next()).shouldSendSuspend$kotlinx_coroutines_core()) {
                        Object objM5138failurePtdJZtk = ChannelResult.INSTANCE.m5138failurePtdJZtk();
                        reentrantLock.unlock();
                        return objM5138failurePtdJZtk;
                    }
                }
            }
            if (this.capacity == -1) {
            ...
            while (it2.hasNext()) {
                ((BufferedChannel) it2.next()).mo5109trySendJP2dKIU(element);
            }
            Object objM5139successJP2dKIU = ChannelResult.INSTANCE.m5139successJP2dKIU(Unit.INSTANCE);
            reentrantLock.unlock();
            return objM5139successJP2dKIU;
        } catch (Throwable th) {
            reentrantLock.unlock();
            throw th;
        }

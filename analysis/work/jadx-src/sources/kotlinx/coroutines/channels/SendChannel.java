...
public interface SendChannel<E> {
    ...
    Object mo5109trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m5134isSuccessimpl(objMo5109trySendJP2dKIU)) {
                return true;
            }
            Throwable thM5128exceptionOrNullimpl = ChannelResult.m5128exceptionOrNullimpl(objMo5109trySendJP2dKIU);
            if (thM5128exceptionOrNullimpl == null) {
                return false;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM5128exceptionOrNullimpl);
        }
    }
}

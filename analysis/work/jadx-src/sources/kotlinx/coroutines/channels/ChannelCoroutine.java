...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo5116receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo5116receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo5117tryReceivePtdJZtk() {
        return this._channel.mo5117tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* JADX INFO: renamed from: trySend-JP2dKIU */
    public Object mo5109trySendJP2dKIU(E e) {
        return this._channel.mo5109trySendJP2dKIU(e);
    }

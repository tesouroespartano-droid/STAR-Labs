...
public interface ReceiveChannel<E> {
    ...
    Object mo5116receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo5117tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo5117tryReceivePtdJZtk = receiveChannel.mo5117tryReceivePtdJZtk();
            if (ChannelResult.m5134isSuccessimpl(objMo5117tryReceivePtdJZtk)) {
                return (E) ChannelResult.m5130getOrThrowimpl(objMo5117tryReceivePtdJZtk);
            }
            Throwable thM5128exceptionOrNullimpl = ChannelResult.m5128exceptionOrNullimpl(objMo5117tryReceivePtdJZtk);
        ...
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) {
            ...
            if (i == 0) {
                ...
                objMo5116receiveCatchingJP2dKIU = receiveChannel.mo5116receiveCatchingJP2dKIU(anonymousClass1);
            ...
            return ChannelResult.m5129getOrNullimpl(objMo5116receiveCatchingJP2dKIU);
        }

...
public final class DelayKt {
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo5176scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m5097delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m5098toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m5098toDelayMillisLRDsOJo(long j) {
        boolean zM4964isPositiveimpl = Duration.m4964isPositiveimpl(j);
        if (zM4964isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m4948getInWholeMillisecondsimpl(Duration.m4966plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (zM4964isPositiveimpl) {

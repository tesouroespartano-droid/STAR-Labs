...
public final class TimeoutKt {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.TimeoutKt", f = "Timeout.kt", i = {0, 0, 0}, l = {InterfaceC0280i1.d.b.b}, m = "withTimeoutOrNull", n = {"block", "coroutine", "timeMillis"}, s = {"L$0", "L$1", "J$0"})
    ...
    public static final <T> Object m5106withTimeoutKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m5098toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    public static final <T> Object m5107withTimeoutOrNullKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m5098toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    public static final TimeoutCancellationException TimeoutCancellationException(long j, Delay delay, Job job) {
        String strM5099timeoutMessageLRDsOJo;
        ...
        if (delayWithTimeoutDiagnostics != null) {
            ...
            strM5099timeoutMessageLRDsOJo = delayWithTimeoutDiagnostics.m5099timeoutMessageLRDsOJo(DurationKt.toDuration(j, DurationUnit.MILLISECONDS));
            if (strM5099timeoutMessageLRDsOJo == null) {
                strM5099timeoutMessageLRDsOJo = "Timed out waiting for " + j + " ms";
            }
        } else {
            strM5099timeoutMessageLRDsOJo = "Timed out waiting for " + j + " ms";
        }
        return new TimeoutCancellationException(strM5099timeoutMessageLRDsOJo, job);
    }
}

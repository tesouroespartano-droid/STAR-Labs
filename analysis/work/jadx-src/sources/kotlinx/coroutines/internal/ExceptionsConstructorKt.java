...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM3604constructorimpl = Result.m3604constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
            ...
            return (E) objM3604constructorimpl;
        }
    ...
    public static final Throwable safeCtor$lambda$9(Function1 function1, Throwable th) {
        ...
        try {
            ...
            objM3604constructorimpl = Result.m3604constructorimpl(th2);
        } catch (Throwable th3) {
            Result.Companion companion2 = Result.INSTANCE;
            objM3604constructorimpl = Result.m3604constructorimpl(ResultKt.createFailure(th3));
        }
        return (Throwable) (Result.m3610isFailureimpl(objM3604constructorimpl) ? null : objM3604constructorimpl);
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM3604constructorimpl = Result.m3604constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM3604constructorimpl = Result.m3604constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m3610isFailureimpl(objM3604constructorimpl)) {
            objM3604constructorimpl = numValueOf;
        }
        return ((Number) objM3604constructorimpl).intValue();
    }

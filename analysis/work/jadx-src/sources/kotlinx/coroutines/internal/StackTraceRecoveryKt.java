...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM3604constructorimpl = Result.m3604constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
        ...
        if (Result.m3607exceptionOrNullimpl(objM3604constructorimpl) == null) {
            obj2 = objM3604constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM3604constructorimpl2 = Result.m3604constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM3604constructorimpl2 = Result.m3604constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m3607exceptionOrNullimpl(objM3604constructorimpl2) == null) {
            obj = objM3604constructorimpl2;
        }

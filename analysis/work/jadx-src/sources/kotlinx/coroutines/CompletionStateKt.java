...
public final class CompletionStateKt {
    public static final <T> Object toState(Object obj) {
        ...
        return thM3607exceptionOrNullimpl == null ? obj : new CompletedExceptionally(thM3607exceptionOrNullimpl, false, 2, null);
    }
    ...
    public static final <T> Object toState(Object obj, CancellableContinuation<?> cancellableContinuation) {
        ...
        if (DebugKt.getRECOVER_STACK_TRACES()) {
            ...
            if (cancellableContinuation2 instanceof CoroutineStackFrame) {
                thM3607exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(thM3607exceptionOrNullimpl, (CoroutineStackFrame) cancellableContinuation2);
            }
        }
        return new CompletedExceptionally(thM3607exceptionOrNullimpl, false, 2, null);
    }
    ...
    public static final <T> Object recoverResult(Object obj, Continuation<? super T> continuation) {
        if (obj instanceof CompletedExceptionally) {
            ...
            return Result.m3604constructorimpl(ResultKt.createFailure(thRecoverFromStackFrame));
        }

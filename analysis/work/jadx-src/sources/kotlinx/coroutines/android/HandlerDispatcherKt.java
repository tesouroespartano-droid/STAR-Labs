...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        Main = (HandlerDispatcher) (Result.m3610isFailureimpl(objM3604constructorimpl) ? null : objM3604constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo5175dispatch(cancellableContinuationImpl2.get$context(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1

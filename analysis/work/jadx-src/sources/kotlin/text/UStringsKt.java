...
public final class UStringsKt {
    ...
    public static final String m4917toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m4919toStringolVBNx4(short s, int i) {
    ...
    public static final String m4918toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m4916toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compareUnsigned(data, UInt.m3699constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m3616boximpl(UByte.m3622constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m3699constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
        return UShort.m3879boximpl(UShort.m3885constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM3699constructorimpl = UInt.m3699constructorimpl(i);
        ...
        while (i2 < length) {
            ...
            if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                if (iDivideUnsigned == 119304647) {
                    iDivideUnsigned = Integer.divideUnsigned(-1, iM3699constructorimpl);
                    if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            int iM3699constructorimpl2 = UInt.m3699constructorimpl(i3 * iM3699constructorimpl);
            int iM3699constructorimpl3 = UInt.m3699constructorimpl(UInt.m3699constructorimpl(iDigitOf) + iM3699constructorimpl2);
            if (Integer.compareUnsigned(iM3699constructorimpl3, iM3699constructorimpl2) < 0) {
                return null;
            }
            i2++;
            i3 = iM3699constructorimpl3;
        }
        return UInt.m3693boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM3778constructorimpl = ULong.m3778constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                if (jDivideUnsigned == 512409557603043100L) {
                    jDivideUnsigned = Long.divideUnsigned(-1L, jM3778constructorimpl);
                    if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            long jM3778constructorimpl2 = ULong.m3778constructorimpl(j * jM3778constructorimpl);
            long jM3778constructorimpl3 = ULong.m3778constructorimpl(ULong.m3778constructorimpl(((long) UInt.m3699constructorimpl(iDigitOf)) & 4294967295L) + jM3778constructorimpl2);
            if (Long.compareUnsigned(jM3778constructorimpl3, jM3778constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j = jM3778constructorimpl3;
        }
        return ULong.m3772boximpl(j);
    }
}

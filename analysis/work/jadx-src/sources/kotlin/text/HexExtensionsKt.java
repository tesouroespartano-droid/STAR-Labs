...
public final class HexExtensionsKt {
    ...
    private static final int checkFormatLength(long j) {
        if (0 > j || j > 2147483647L) {
            throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m3824toStringimpl(ULong.m3778constructorimpl(j))));
        }
        return (int) j;
    }

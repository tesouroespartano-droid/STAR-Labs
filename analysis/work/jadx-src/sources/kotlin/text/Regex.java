...
public final class Regex implements Serializable {
    ...
    public final Sequence<String> splitToSequence(CharSequence input, int limit) {
        Intrinsics.checkNotNullParameter(input, "input");
        StringsKt.requireNonNegativeLimit(limit);
        return SequencesKt.sequence(new C08161(input, limit, null));
    }
    ...
    static final class C08161 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super String>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C08161(CharSequence charSequence, int i, Continuation<? super C08161> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C08161 c08161 = Regex.this.new C08161(this.$input, this.$limit, continuation);
            c08161.L$0 = obj;
            return c08161;
        }
        ...
        public final Object invoke(SequenceScope<? super String> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C08161) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }

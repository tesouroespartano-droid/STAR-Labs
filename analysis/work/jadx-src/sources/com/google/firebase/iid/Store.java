    ...
    static class Token {
        ...
        static String encode(String str, String str2, long j) {
            try {
                ...
                jSONObject.put(C0198d4.j.W, str2);
                jSONObject.put(F4.a.d, j);
        ...
        static Token parse(String str) {
            ...
            try {
                ...
                return new Token(jSONObject.getString("token"), jSONObject.getString(C0198d4.j.W), jSONObject.getLong(F4.a.d));
            } catch (JSONException e) {
                String strValueOf = String.valueOf(e);

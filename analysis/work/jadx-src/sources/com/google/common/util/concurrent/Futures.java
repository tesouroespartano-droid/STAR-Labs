...
public final class Futures extends GwtFuturesCatchingSpecialization {
    ...
    private static final class NonCancellationPropagatingFuture<V> extends AbstractFuture.TrustedFuture<V> implements Runnable {
        ...
        protected String pendingToString() {
            ...
            return new StringBuilder(String.valueOf(strValueOf).length() + 11).append("delegate=[").append(strValueOf).append(C0198d4.j.e).toString();
        }
    ...
    private static final class InCompletionOrderFuture<T> extends AbstractFuture<T> {
        ...
        protected String pendingToString() {
            ...
            return new StringBuilder(49).append("inputCount=[").append(length).append("], remaining=[").append(((InCompletionOrderState) inCompletionOrderState).incompleteOutputCount.get()).append(C0198d4.j.e).toString();
        }
    }

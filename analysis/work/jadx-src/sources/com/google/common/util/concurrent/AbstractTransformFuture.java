...
abstract class AbstractTransformFuture<I, O, F, T> extends FluentFuture.TrustedFuture<O> implements Runnable {
    ...
    protected String pendingToString() {
        ...
        if (f != null) {
            ...
            return new StringBuilder(String.valueOf(string).length() + 11 + String.valueOf(strValueOf2).length()).append(string).append("function=[").append(strValueOf2).append(C0198d4.j.e).toString();
        }

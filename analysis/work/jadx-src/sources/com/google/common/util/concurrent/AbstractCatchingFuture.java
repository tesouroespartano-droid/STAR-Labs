...
abstract class AbstractCatchingFuture<V, X extends Throwable, F, T> extends FluentFuture.TrustedFuture<V> implements Runnable {
    ...
    protected String pendingToString() {
        ...
        if (cls != null && f != null) {
            ...
            return new StringBuilder(String.valueOf(string).length() + 29 + String.valueOf(strValueOf2).length() + String.valueOf(strValueOf3).length()).append(string).append("exceptionType=[").append(strValueOf2).append("], fallback=[").append(strValueOf3).append(C0198d4.j.e).toString();
        }

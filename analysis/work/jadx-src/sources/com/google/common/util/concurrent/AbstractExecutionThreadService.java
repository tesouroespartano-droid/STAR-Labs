...
public abstract class AbstractExecutionThreadService implements Service {
    ...
    public String toString() {
        ...
        return new StringBuilder(String.valueOf(strServiceName).length() + 3 + String.valueOf(strValueOf).length()).append(strServiceName).append(" [").append(strValueOf).append(C0198d4.j.e).toString();
    }

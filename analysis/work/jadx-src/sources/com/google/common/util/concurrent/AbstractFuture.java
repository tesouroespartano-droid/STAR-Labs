...
import com.google.android.gms.internal.play_billing.zzcm$$ExternalSyntheticBackportWithForwarding0;
...
public abstract class AbstractFuture<V> extends InternalFutureFailureAccess implements ListenableFuture<V> {
    ...
    public String toString() {
        ...
        return sb.append(C0198d4.j.e).toString();
    }
    ...
    private void addPendingString(StringBuilder sb) {
        ...
        if (obj instanceof SetFuture) {
            ...
            if (string != null) {
                sb.append(", info=[").append(string).append(C0198d4.j.e);
            }
        }
        if (isDone()) {
    ...
    private void addDoneString(StringBuilder sb) {
        try {
            ...
            sb.append("FAILURE, cause=[").append(e2.getCause()).append(C0198d4.j.e);
        }
    }
    ...
    private static final class UnsafeAtomicHelper extends AtomicHelper {
        ...
        boolean casWaiters(AbstractFuture<?> abstractFuture, @CheckForNull Waiter waiter, @CheckForNull Waiter waiter2) {
            return zzcm$$ExternalSyntheticBackportWithForwarding0.m(UNSAFE, abstractFuture, WAITERS_OFFSET, waiter, waiter2);
        }

        @Override // com.google.common.util.concurrent.AbstractFuture.AtomicHelper
        boolean casListeners(AbstractFuture<?> abstractFuture, @CheckForNull Listener listener, Listener listener2) {
            return zzcm$$ExternalSyntheticBackportWithForwarding0.m(UNSAFE, abstractFuture, LISTENERS_OFFSET, listener, listener2);
        }
        ...
        boolean casValue(AbstractFuture<?> abstractFuture, @CheckForNull Object obj, Object obj2) {
            return zzcm$$ExternalSyntheticBackportWithForwarding0.m(UNSAFE, abstractFuture, VALUE_OFFSET, obj, obj2);
        }
    }

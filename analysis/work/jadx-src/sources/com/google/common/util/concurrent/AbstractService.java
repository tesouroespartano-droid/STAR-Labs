...
public abstract class AbstractService implements Service {
    ...
    public String toString() {
        ...
        String strValueOf = String.valueOf(state());
        return new StringBuilder(String.valueOf(simpleName).length() + 3 + String.valueOf(strValueOf).length()).append(simpleName).append(" [").append(strValueOf).append(C0198d4.j.e).toString();
    }

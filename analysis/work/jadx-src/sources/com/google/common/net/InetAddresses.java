...
public final class InetAddresses {
    ...
    public static String toUriString(InetAddress inetAddress) {
        if (inetAddress instanceof Inet6Address) {
            ...
            return new StringBuilder(String.valueOf(addrString).length() + 2).append(C0198d4.j.d).append(addrString).append(C0198d4.j.e).toString();
        }
    ...
    private static InetAddress forUriStringNoThrow(String str) {
        ...
        if (str.startsWith(C0198d4.j.d) && str.endsWith(C0198d4.j.e)) {

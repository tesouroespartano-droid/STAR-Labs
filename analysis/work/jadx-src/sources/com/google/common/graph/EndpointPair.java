...
public abstract class EndpointPair<N> implements Iterable<N> {
    ...
    private static final class Unordered<N> extends EndpointPair<N> {
        ...
        public String toString() {
            ...
            return new StringBuilder(String.valueOf(strValueOf).length() + 4 + String.valueOf(strValueOf2).length()).append(C0198d4.j.d).append(strValueOf).append(", ").append(strValueOf2).append(C0198d4.j.e).toString();
        }
    }
}

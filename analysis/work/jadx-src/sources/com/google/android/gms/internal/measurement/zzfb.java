...
public final class zzfb {
    ...
    public final Map zzC(String str, String str2, boolean z) {
        ...
        Bundle bundleZze = zzcoVar.zze(ServiceProvider.SCAR_VERSION_FETCH_TIMEOUT);
    ...
    public final Bundle zzE(Bundle bundle, boolean z) {
        ...
        if (z) {
            return zzcoVar.zze(ServiceProvider.SCAR_VERSION_FETCH_TIMEOUT);
        }
        return null;
    }
    ...
    public final List zzn(String str, String str2) {
        ...
        List list = (List) zzco.zzf(zzcoVar.zze(ServiceProvider.SCAR_VERSION_FETCH_TIMEOUT), List.class);

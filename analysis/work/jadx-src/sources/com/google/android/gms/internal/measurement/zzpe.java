...
public final class zzpe implements zzpd {
    ...
    static {
        ...
        zzG = zzkgVarZzb.zzc("measurement.service_client.idle_disconnect_millis", ServiceProvider.SCAR_VERSION_FETCH_TIMEOUT);
        ...
        zzP = zzkgVarZzb.zzc("measurement.sgtm.upload.max_queued_batches", ServiceProvider.SCAR_VERSION_FETCH_TIMEOUT);
        ...
        zzS = zzkgVarZzb.zzc("measurement.sgtm.upload.min_delay_after_startup", ServiceProvider.SCAR_VERSION_FETCH_TIMEOUT);

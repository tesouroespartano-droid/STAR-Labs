    ...
    public static AppMeasurement getInstance(Context context) {
        ...
        if (zza == null) {
            synchronized (AppMeasurement.class) {
                if (zza == null) {
                    try {
                        zzlkVar = (zzlk) Class.forName(Constants.FID_CLASS).getDeclaredMethod("getScionFrontendApiImplementation", Context.class, Bundle.class).invoke(null, context, null);

...
public class TreeWalker implements com.iab.omid.library.ironsrc.processor.a.InterfaceC0029a {
    ...
    private boolean a(View view, JSONObject jSONObject) {
        com.iab.omid.library.ironsrc.walking.a.C0031a c0031aB = this.f.b(view);
        if (c0031aB == null) {
            return false;
        }
        com.iab.omid.library.ironsrc.utils.c.a(jSONObject, c0031aB);
        return true;
    }
    ...
    @Override // com.iab.omid.library.ironsrc.processor.a.InterfaceC0029a

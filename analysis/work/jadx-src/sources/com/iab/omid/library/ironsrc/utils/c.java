...
public class c {
    ...
    public static void a(JSONObject jSONObject, com.iab.omid.library.ironsrc.walking.a.C0031a c0031a) {
        com.iab.omid.library.ironsrc.internal.e eVarA = c0031a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0031a.b().iterator();
        while (it.hasNext()) {
    ...
    public static void a(JSONObject jSONObject, String str, Object obj) {
        try {
            ...
            d.a("JSONException during JSONObject.put for name [" + str + C0198d4.j.e, e);
        }
    }

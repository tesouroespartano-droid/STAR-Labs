...
public class b extends AdSessionStatePublisher {
    ...
    public void b() {
        super.b();
        new Handler().postDelayed(new RunnableC0034b(), Math.max(4000 - (this.h == null ? 4000L : TimeUnit.MILLISECONDS.convert(f.b() - this.h.longValue(), TimeUnit.NANOSECONDS)), 2000L));
        this.g = null;
    }

...
public class a {
    ...
    private final HashMap<View, C0031a> b = new HashMap<>();
    ...
    public static class C0031a {
        ...
        public C0031a(e eVar, String str) {
            this.a = eVar;
            a(str);
        }
    ...
    private void a(e eVar, com.iab.omid.library.ironsrc.adsession.a aVar) {
        ...
        C0031a c0031a = this.b.get(view);
        if (c0031a != null) {
            c0031a.a(aVar.getAdSessionId());
        } else {
            this.b.put(view, new C0031a(eVar, aVar.getAdSessionId()));
        }
    }

...
public class a {
    ...
    private final HashMap<View, C0035a> b = new HashMap<>();
    ...
    private void a(e eVar, com.iab.omid.library.unity3d.adsession.a aVar) {
        ...
        C0035a c0035a = this.b.get(view);
        if (c0035a != null) {
            c0035a.a(aVar.getAdSessionId());
        } else {
            this.b.put(view, new C0035a(eVar, aVar.getAdSessionId()));
        }
    }

...
public class c {
    ...
    public static void a(JSONObject jSONObject, com.iab.omid.library.unity3d.walking.a.C0035a c0035a) {
        com.iab.omid.library.unity3d.internal.e eVarA = c0035a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0035a.b().iterator();
        while (it.hasNext()) {

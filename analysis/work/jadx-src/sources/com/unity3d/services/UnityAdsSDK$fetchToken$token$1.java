...
final class UnityAdsSDK$fetchToken$token$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super String>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        ResultKt.throwOnFailure(obj);
        this.label = 1;
        Object objInvoke$default = GetHeaderBiddingToken.DefaultImpls.invoke$default(UnityAdsSDK.fetchToken$lambda$10(this.$getHeaderBiddingToken$delegate), UnityAdsSDK.fetchToken$lambda$9(this.$tokenNumberProvider$delegate).invoke(), null, this, 2, null);

...
public final class ResultExtensionsKt {
    public static final /* synthetic */ <E extends Exception> E getCustomExceptionOrNull(Object obj) {
        ...
        if (thM3607exceptionOrNullimpl instanceof Exception) {
            return (E) thM3607exceptionOrNullimpl;
        }
        return null;
    }
    ...
    public static final InitializationException getInitializationExceptionOrNull(Object obj) {
        Throwable thM3607exceptionOrNullimpl = Result.m3607exceptionOrNullimpl(obj);
        if (thM3607exceptionOrNullimpl instanceof InitializationException) {
            return (InitializationException) thM3607exceptionOrNullimpl;
        }
        return null;
    }

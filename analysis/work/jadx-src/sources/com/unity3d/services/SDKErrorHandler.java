...
public final class SDKErrorHandler implements CoroutineExceptionHandler {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            SendDiagnosticEvent.DefaultImpls.invoke$default(SDKErrorHandler.this.sendDiagnosticEvent, this.$name, null, MapsKt.mapOf(TuplesKt.to("reason", this.$reason), TuplesKt.to("reason_debug", this.$stackTrace), TuplesKt.to("coroutine_name", this.$scopeName)), null, null, null, 58, null);

...
public final class AndroidOpenMeasurementRepository implements OpenMeasurementRepository {
    ...
    static final class C06342 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super OMResult>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06342(ByteString byteString, OmidOptions omidOptions, WebView webView, Continuation<? super C06342> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return AndroidOpenMeasurementRepository.this.new C06342(this.$opportunityId, this.$options, this.$webView, continuation);
        }
    ...
    public Object startSession(ByteString byteString, WebView webView, OmidOptions omidOptions, Continuation<? super OMResult> continuation) {
        return BuildersKt.withContext(this.mainDispatcher, new C06342(byteString, omidOptions, webView, null), continuation);
    }
    ...
    static final class C06322 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super OMResult>, Object> {
        final /* synthetic */ ByteString $opportunityId;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06322(ByteString byteString, Continuation<? super C06322> continuation) {
            super(2, continuation);
            this.$opportunityId = byteString;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return AndroidOpenMeasurementRepository.this.new C06322(this.$opportunityId, continuation);
        }
    ...
    public Object finishSession(ByteString byteString, Continuation<? super OMResult> continuation) {
        return BuildersKt.withContext(this.mainDispatcher, new C06322(byteString, null), continuation);
    }
    ...
    static final class C06332 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super OMResult>, Object> {
        final /* synthetic */ ByteString $opportunityId;
        final /* synthetic */ boolean $signalLoaded;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06332(ByteString byteString, boolean z, Continuation<? super C06332> continuation) {
            super(2, continuation);
            this.$opportunityId = byteString;
            this.$signalLoaded = z;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return AndroidOpenMeasurementRepository.this.new C06332(this.$opportunityId, this.$signalLoaded, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super OMResult> continuation) {
            return ((C06332) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public Object impressionOccurred(ByteString byteString, boolean z, Continuation<? super OMResult> continuation) {
        return BuildersKt.withContext(this.mainDispatcher, new C06332(byteString, z, null), continuation);
    }

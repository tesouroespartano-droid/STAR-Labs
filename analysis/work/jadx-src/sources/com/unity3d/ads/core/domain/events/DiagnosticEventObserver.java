    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ...
                FlowKt.launchIn(FlowKt.onEach(DiagnosticEventObserver.this.diagnosticEventRepository.getDiagnosticEvents(), new C00832(DiagnosticEventObserver.this, null)), CoroutineScopeKt.CoroutineScope(DiagnosticEventObserver.this.defaultDispatcher));
                return Unit.INSTANCE;
            }
        ...
        @DebugMetadata(c = "com.unity3d.ads.core.domain.events.DiagnosticEventObserver$invoke$2$2", f = "DiagnosticEventObserver.kt", i = {1}, l = {MotionEventCompat.AXIS_GENERIC_11, 45}, m = "invokeSuspend", n = {"workId"}, s = {"L$0"})
        static final class C00832 extends SuspendLambda implements Function2<List<? extends DiagnosticEventRequestOuterClass.DiagnosticEvent>, Continuation<? super Unit>, Object> {
            /* synthetic */ Object L$0;
            int label;
            final /* synthetic */ DiagnosticEventObserver this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00832(DiagnosticEventObserver diagnosticEventObserver, Continuation<? super C00832> continuation) {
                super(2, continuation);
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C00832 c00832 = new C00832(this.this$0, continuation);
                c00832.L$0 = obj;
                return c00832;
            }
            ...
            public final Object invoke2(List<DiagnosticEventRequestOuterClass.DiagnosticEvent> list, Continuation<? super Unit> continuation) {
                return ((C00832) create(list, continuation)).invokeSuspend(Unit.INSTANCE);
            }

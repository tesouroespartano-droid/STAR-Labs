    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ...
                FlowKt.launchIn(FlowKt.onEach(OperativeEventObserver.this.operativeEventRepository.getOperativeEvents(), new C00842(OperativeEventObserver.this, null)), CoroutineScopeKt.CoroutineScope(OperativeEventObserver.this.defaultDispatcher));
                return Unit.INSTANCE;
            }
        ...
        @DebugMetadata(c = "com.unity3d.ads.core.domain.events.OperativeEventObserver$invoke$2$2", f = "OperativeEventObserver.kt", i = {1}, l = {40, MotionEventCompat.AXIS_GENERIC_12}, m = "invokeSuspend", n = {"workId"}, s = {"L$0"})
        static final class C00842 extends SuspendLambda implements Function2<OperativeEventRequestOuterClass.OperativeEventRequest, Continuation<? super Unit>, Object> {
            /* synthetic */ Object L$0;
            int label;
            final /* synthetic */ OperativeEventObserver this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00842(OperativeEventObserver operativeEventObserver, Continuation<? super C00842> continuation) {
                super(2, continuation);
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C00842 c00842 = new C00842(this.this$0, continuation);
                c00842.L$0 = obj;
                return c00842;
            }
            ...
            public final Object invoke(OperativeEventRequestOuterClass.OperativeEventRequest operativeEventRequest, Continuation<? super Unit> continuation) {
                return ((C00842) create(operativeEventRequest, continuation)).invokeSuspend(Unit.INSTANCE);
            }

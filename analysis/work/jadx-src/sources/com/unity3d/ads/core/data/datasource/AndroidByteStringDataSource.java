...
public final class AndroidByteStringDataSource implements ByteStringDataSource {
    ...
    public Object get(Continuation<? super ByteStringStoreOuterClass.ByteStringStore> continuation) {
        return FlowKt.first(FlowKt.m5145catch(this.dataStore.getData(), new AnonymousClass2(null)), continuation);
    }
    ...
    static final class C06162 extends SuspendLambda implements Function2<ByteStringStoreOuterClass.ByteStringStore, Continuation<? super ByteStringStoreOuterClass.ByteStringStore>, Object> {
        final /* synthetic */ ByteString $data;
        /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06162(ByteString byteString, Continuation<? super C06162> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C06162 c06162 = new C06162(this.$data, continuation);
            c06162.L$0 = obj;
            return c06162;
        }
        ...
        public final Object invoke(ByteStringStoreOuterClass.ByteStringStore byteStringStore, Continuation<? super ByteStringStoreOuterClass.ByteStringStore> continuation) {
            return ((C06162) create(byteStringStore, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public Object set(ByteString byteString, Continuation<? super Unit> continuation) {
        Object objUpdateData = this.dataStore.updateData(new C06162(byteString, null), continuation);

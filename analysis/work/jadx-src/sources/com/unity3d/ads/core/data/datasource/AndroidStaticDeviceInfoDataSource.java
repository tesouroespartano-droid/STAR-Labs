...
public final class AndroidStaticDeviceInfoDataSource implements StaticDeviceInfoDataSource {
    ...
    public final Object getGPUModel(Continuation<? super String> continuation) {
        ...
        if (i == 0) {
            ...
            c06171.label = 1;
            obj = byteStringDataSource.get(c06171);

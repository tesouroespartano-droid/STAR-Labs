...
public interface BannerShowListener {
    void unityAdsBannerDidClick(BannerAd banner);

    void unityAdsBannerDidFailShow(BannerAd banner, UnityAdsError error);

    void unityAdsBannerImpression(BannerAd banner);
}

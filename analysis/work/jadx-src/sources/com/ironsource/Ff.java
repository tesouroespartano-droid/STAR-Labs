...
public final class Ff implements InterfaceC0448rf {
    ...
    public static final class a extends WebViewClient {
        ...
        public void onPageFinished(WebView webView, String str) throws JSONException {
            if (!Ff.this.e && str != null && StringsKt.startsWith$default(str, String.valueOf(this.b), false, 2, (Object) null)) {
                Ff ff = Ff.this;
                List<? extends Object> listListOf = CollectionsKt.listOf(ff.d);
                Intrinsics.checkNotNull(listListOf, "null cannot be cast to non-null type kotlin.collections.List<kotlin.Any?>");
                ff.a(ff.a("onDataReady", listListOf));
                C0381nf.a.d();
                Ff.this.e = true;
            }
        ...
        public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) throws JSONException {
            ...
            C0381nf.a.a(error.toString());
            C0584zf.a.b("got error during TestSuite web controller loading " + error);
    ...
    public static final class b implements S8 {
        ...
        public void onUIReady() {
            if (Ff.this.f) {
                ...
                Ff.this.a.postDelayed(new Runnable() { // from class: com.ironsource.Ff$b$$ExternalSyntheticLambda0
    ...
    public Ff(TestSuiteActivity activity, S8 uiLifeCycleListener, JSONObject jsonData, String str) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void e(Ff this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.f = true;
    }
    ...
    private final void a(TestSuiteActivity testSuiteActivity, final S8 s8, String str) {
        WebView webView = this.b;
        ...
        if (this.g.a() != null) {
            Iterator<IronSource.AD_UNIT> it = com.ironsource.mediationsdk.p.m().p().iterator();
            while (it.hasNext()) {
        ...
        this.c.addJavascriptInterface(new C0432qf(new C0364mf.a().a(listMutableListOf, testSuiteActivity, this.a), new b(s8), this), "TestSuiteBridge");
        ...
        this.a.postDelayed(new Runnable() { // from class: com.ironsource.Ff$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                Ff.e(this.f$0);
            }
        }, 2000L);
        this.a.postDelayed(new Runnable() { // from class: com.ironsource.Ff$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                Ff.a(s8);
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void a(S8 uiLifeCycleListener) {
        Intrinsics.checkNotNullParameter(uiLifeCycleListener, "$uiLifeCycleListener");
        uiLifeCycleListener.onUIReady();
    }

    @Override // com.ironsource.InterfaceC0448rf
    ...
    public final void a(final String script) {
        ...
        this.a.post(new Runnable() { // from class: com.ironsource.Ff$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                Ff.a(this.f$0, script);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void a(Ff this$0, String script) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(script, "$script");

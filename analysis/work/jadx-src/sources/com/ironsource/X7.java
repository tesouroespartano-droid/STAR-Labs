...
public class X7 extends Z7.a<ISDemandOnlyInterstitialListener> implements ISDemandOnlyInterstitialListener {
    ...
    class a implements Runnable {
        ...
        public void run() {
            X7.this.a(this.a, "onInterstitialAdReady()");
    ...
    class b implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            X7.this.a(this.a, "onInterstitialAdLoadFailed() error = " + this.b.getErrorMessage());
    ...
    class c implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            X7.this.a(this.a, "onInterstitialAdOpened()");
    ...
    class d implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            X7.this.a(this.a, "onInterstitialAdShowFailed() error = " + this.b.getErrorMessage());
    ...
    class e implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            X7.this.a(this.a, "onInterstitialAdClicked()");
    ...
    class f implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            X7.this.a(this.a, "onInterstitialAdClosed()");

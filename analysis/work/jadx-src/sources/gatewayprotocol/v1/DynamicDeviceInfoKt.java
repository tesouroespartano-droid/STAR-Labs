...
public final class DynamicDeviceInfoKt {
    ...
    public final DynamicDeviceInfoOuterClass.DynamicDeviceInfo.Android m3560initializeandroid(Function1<? super AndroidKt.Dsl, Unit> block) {
    ...
    public final DynamicDeviceInfoOuterClass.DynamicDeviceInfo.Ios m3561initializeios(Function1<? super IosKt.Dsl, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");

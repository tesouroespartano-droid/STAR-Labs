...
public final class UniversalRequestKt {
    ...
    public final UniversalRequestOuterClass.UniversalRequest.SharedData m3596initializesharedData(Function1<? super SharedDataKt.Dsl, Unit> block) {
    ...
    public final UniversalRequestOuterClass.UniversalRequest.Payload m3595initializepayload(Function1<? super PayloadKt.Dsl, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");

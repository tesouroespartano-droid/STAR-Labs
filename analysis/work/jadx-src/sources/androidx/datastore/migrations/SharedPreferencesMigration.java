...
public final class SharedPreferencesMigration<T> implements DataMigration<T> {
    ...
    static final class C01271 extends ContinuationImpl {
        ...
        C01271(SharedPreferencesMigration<T> sharedPreferencesMigration, Continuation<? super C01271> continuation) {
            super(continuation);
    ...
    public Object shouldMigrate(T t, Continuation<? super Boolean> continuation) {
        ...
        if (continuation instanceof C01271) {
            ...
            if ((c01271.label & Integer.MIN_VALUE) != 0) {
                ...
                c01271 = new C01271(this, continuation);
            }
        } else {
            c01271 = new C01271(this, continuation);
        }
        ...
        if (i == 0) {
            ...
            c01271.L$0 = this;
            c01271.label = 1;
            objInvoke = function2.invoke(t, c01271);
            ...
            sharedPreferencesMigration = (SharedPreferencesMigration) c01271.L$0;
            ResultKt.throwOnFailure(objInvoke);
        }

...
public final class SimpleActor<T> {
        ...
        if (job != null) {
            job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: androidx.datastore.core.SimpleActor.1
                ...
                public final void invoke2(Throwable th) {
                    ...
                    do {
                        Object objM5129getOrNullimpl = ChannelResult.m5129getOrNullimpl(((SimpleActor) this).messageQueue.mo5117tryReceivePtdJZtk());
                        if (objM5129getOrNullimpl != null) {
                            onUndeliveredElement.invoke((T) objM5129getOrNullimpl, th);
                            unit = Unit.INSTANCE;
                        } else {
                            unit = null;
                        }
    ...
    public final void offer(T msg) {
        Object obj = this.messageQueue.mo5109trySendJP2dKIU(msg);
        if (obj instanceof ChannelResult.Closed) {
            Throwable thM5128exceptionOrNullimpl = ChannelResult.m5128exceptionOrNullimpl(obj);
            if (thM5128exceptionOrNullimpl != null) {
                throw thM5128exceptionOrNullimpl;
            }
            throw new ClosedSendChannelException("Channel was closed normally");
        }
        if (!ChannelResult.m5134isSuccessimpl(obj)) {

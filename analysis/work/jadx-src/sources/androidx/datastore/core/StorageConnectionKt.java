...
public final class StorageConnectionKt {
    ...
    static final class C01252<T> extends SuspendLambda implements Function2<WriteScope<T>, Continuation<? super Unit>, Object> {
        final /* synthetic */ T $value;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01252(T t, Continuation<? super C01252> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C01252 c01252 = new C01252(this.$value, continuation);
            c01252.L$0 = obj;
            return c01252;
        }
        ...
        public final Object invoke(WriteScope<T> writeScope, Continuation<? super Unit> continuation) {
            return ((C01252) create(writeScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Object writeData(StorageConnection<T> storageConnection, T t, Continuation<? super Unit> continuation) {
        Object objWriteScope = storageConnection.writeScope(new C01252(t, null), continuation);

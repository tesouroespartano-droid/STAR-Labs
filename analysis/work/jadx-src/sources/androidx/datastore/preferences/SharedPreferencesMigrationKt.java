...
public final class SharedPreferencesMigrationKt {
    ...
    static final class C01281 extends SuspendLambda implements Function2<Preferences, Continuation<? super Boolean>, Object> {
        final /* synthetic */ Set<String> $keysToMigrate;
        /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01281(Set<String> set, Continuation<? super C01281> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C01281 c01281 = new C01281(this.$keysToMigrate, continuation);
            c01281.L$0 = obj;
            return c01281;
        }
        ...
        public final Object invoke(Preferences preferences, Continuation<? super Boolean> continuation) {
            return ((C01281) create(preferences, continuation)).invokeSuspend(Unit.INSTANCE);
        }

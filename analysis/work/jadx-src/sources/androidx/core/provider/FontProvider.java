...
class FontProvider {
    ...
    static FontsContractCompat.FontInfo[] query(Context context, FontRequest fontRequest, String str, CancellationSignal cancellationSignal) throws Throwable {
        ...
        Uri uriBuild2 = new Uri.Builder().scheme("content").authority(str).appendPath(C0198d4.i.b).build();
        try {
            int i = 0;
                ...
                try {
                    if (cursorQuery.getCount() > 0) {
                        ...
                        while (cursorQuery.moveToNext()) {
                            ...
                            int i4 = columnIndex5 != -1 ? cursorQuery.getInt(columnIndex5) : CommonGatewayClient.CODE_400;
                            if (columnIndex6 != -1) {
                                z = true;

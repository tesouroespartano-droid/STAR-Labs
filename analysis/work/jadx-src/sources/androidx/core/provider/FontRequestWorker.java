...
class FontRequestWorker {
    ...
    private static final ExecutorService DEFAULT_EXECUTOR_SERVICE = RequestExecutor.createDefaultExecutor("fonts-androidx", 10, UnityAdsConstants.AdOperations.SHOW_TIMEOUT_MS);

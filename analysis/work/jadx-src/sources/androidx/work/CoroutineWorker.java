...
public abstract class CoroutineWorker extends ListenableWorker {
    ...
    static final class C01351 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return CoroutineWorker.this.new C01351(continuation);
        }
    ...
    public final ListenableFuture<ListenableWorker.Result> startWork() {
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(getCoroutineContext().plus(this.job)), null, null, new C01351(null), 3, null);
        return this.future;
    }
    ...
    public final ListenableFuture<ForegroundInfo> getForegroundInfoAsync() {
        ...
        BuildersKt__Builders_commonKt.launch$default(CoroutineScope, null, null, new C01341(jobListenableFuture, this, null), 3, null);
    ...
    static final class C01341 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01341(JobListenableFuture<ForegroundInfo> jobListenableFuture, CoroutineWorker coroutineWorker, Continuation<? super C01341> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C01341(this.$jobFuture, this.this$0, continuation);
        }

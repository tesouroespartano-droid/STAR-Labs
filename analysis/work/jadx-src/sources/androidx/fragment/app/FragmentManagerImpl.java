...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    /* JADX WARN: Code duplicated, block: B:26:0x0066 A[Catch: RuntimeException -> 0x006c, TRY_LEAVE, TryCatch #2 {RuntimeException -> 0x006c, blocks: (B:24:0x005a, B:26:0x0066), top: B:60:0x005a }] */
        ...
        if (nextAnim != 0) {
            ...
            if (zEquals) {
                try {
                    ...
                    try {
                        animatorLoadAnimator = AnimatorInflater.loadAnimator(this.mHost.getContext(), nextAnim);
    ...
    /* JADX WARN: Code duplicated, block: B:152:0x02f2  */
    /* JADX WARN: Code duplicated, block: B:156:0x030d  */
    /* JADX WARN: Code duplicated, block: B:158:0x0311  */
    /* JADX WARN: Code duplicated, block: B:217:0x0416  */
    /* JADX WARN: Code duplicated, block: B:219:0x041a  */
    /* JADX WARN: Code duplicated, block: B:221:0x0420  */
    /* JADX WARN: Code duplicated, block: B:222:0x042b  */
    /* JADX WARN: Code duplicated, block: B:224:0x0431  */
    /* JADX WARN: Code duplicated, block: B:272:0x04ea  */
        ...
        if (fragment.mState <= i8) {
                ...
                if (!fragment2.mFromLayout) {
                    if (fragment2.mContainerId != 0) {
                        ...
                        if (viewGroup == null && !fragment2.mRestored) {
                            ...
                            fragmentManagerImpl.throwException(new IllegalArgumentException("No view found for id 0x" + Integer.toHexString(fragment2.mContainerId) + " (" + resourceName + ") for fragment " + fragment2));
                        }
                    } else {
                        viewGroup = null;
                    }
            ...
            if (fragment2.mState > i8) {
                ...
                if (i10 != 1) {
                    ...
                    if (i8 < 2) {
                        ...
                        if (fragment2.mView != null && fragment2.mContainer != null) {
                            ...
                            if (fragment2.getParentFragment() == null || !fragment2.getParentFragment().mRemoving) {
                                AnimationOrAnimator animationOrAnimatorLoadAnimation = (this.mCurState <= 0 || this.mDestroyed || fragment2.mView.getVisibility() != 0 || fragment2.mPostponedAlpha < 0.0f) ? null : loadAnimation(fragment2, i2, false, i3);
                                fragment2.mPostponedAlpha = 0.0f;
                                if (animationOrAnimatorLoadAnimation != null) {
                                    animateRemoveFragment(fragment2, animationOrAnimatorLoadAnimation, i8);
                                }
                    ...
                    if (this.mDestroyed) {
                        if (fragment2.getAnimatingAway() != null) {
                            View animatingAway2 = fragment2.getAnimatingAway();
                            fragment2.setAnimatingAway(null);
    ...
    void restoreSaveState(Parcelable parcelable) {
        ...
        for (Fragment fragment : this.mNonConfig.getRetainedFragments()) {
            ...
            do {
                ...
                next = it.next();
            } while (!next.mWho.equals(fragment.mWho));
            if (next == null) {
                if (DEBUG) {

...
public final class Cookie {
    ...
    static Cookie parse(long j, HttpUrl httpUrl, String str) {
        ...
        int iDelimiterOffset2 = Util.delimiterOffset(str, 0, iDelimiterOffset, F5.T);
        String domain = null;
        ...
        while (i < length) {
            ...
            int iDelimiterOffset4 = Util.delimiterOffset(str, i, iDelimiterOffset3, F5.T);
            ...
            if (strTrimSubstring4.equalsIgnoreCase("expires")) {
                ...
                z3 = true;
            } else if (strTrimSubstring4.equalsIgnoreCase(C0198d4.j.D)) {
    ...
    public int hashCode() {
        int iHashCode = (((((((IronSourceError.ERROR_NON_EXISTENT_INSTANCE + this.name.hashCode()) * 31) + this.value.hashCode()) * 31) + this.domain.hashCode()) * 31) + this.path.hashCode()) * 31;

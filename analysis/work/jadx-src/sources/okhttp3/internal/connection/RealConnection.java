...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    /* JADX WARN: Code duplicated, block: B:81:0x013b A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:82:0x013b A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:83:? A[LOOP:0: B:69:0x0081->B:83:?, LOOP_END, SYNTHETIC] */
    ...
    private Request createTunnel(int i, int i2, Request request, HttpUrl httpUrl) throws IOException {
        ...
        while (true) {
            ...
            if (iCode == 407) {
                ...
                if ("close".equalsIgnoreCase(responseBuild.header(com.google.common.net.HttpHeaders.CONNECTION))) {
    ...
    private Request createTunnelRequest() throws IOException {
        Request requestBuild = new Request.Builder().url(this.route.address().url()).method("CONNECT", null).header(com.google.common.net.HttpHeaders.HOST, Util.hostHeader(this.route.address().url(), true)).header("Proxy-Connection", com.google.common.net.HttpHeaders.KEEP_ALIVE).header(com.google.common.net.HttpHeaders.USER_AGENT, Version.userAgent()).build();
        Request requestAuthenticate = this.route.address().proxyAuthenticator().authenticate(this.route, new Response.Builder().request(requestBuild).protocol(Protocol.HTTP_1_1).code(InterfaceC0280i1.a.b.g).message("Preemptive Authenticate").body(Util.EMPTY_RESPONSE).sentRequestAtMillis(-1L).receivedResponseAtMillis(-1L).header(com.google.common.net.HttpHeaders.PROXY_AUTHENTICATE, "OkHttp-Preemptive").build());

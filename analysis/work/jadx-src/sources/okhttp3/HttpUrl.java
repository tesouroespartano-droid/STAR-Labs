...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        private Builder addPathSegments(String str, boolean z) throws EOFException {
            int i = 0;
            while (true) {
        ...
        Builder parse(@Nullable HttpUrl httpUrl, String str) throws EOFException {
            ...
            if (iSchemeDelimiterOffset != -1) {
                if (str4.regionMatches(true, iSkipLeadingAsciiWhitespace, "https:", 0, 6)) {
                    ...
                    if (str4.regionMatches(true, iSkipLeadingAsciiWhitespace, "http:", 0, 5)) {
                        ...
                        throw new IllegalArgumentException("Expected URL scheme 'http' or 'https' but was '" + str4.substring(0, iSchemeDelimiterOffset) + "'");
                    }
                }
            ...
            if (iSlashCount >= 2 || httpUrl == null || !httpUrl.scheme.equals(this.scheme)) {
                ...
                boolean z2 = false;
                while (true) {
                    iDelimiterOffset = Util.delimiterOffset(str4, i2, iSkipTrailingAsciiWhitespace, "@/\\?#");
                    byte bCharAt = iDelimiterOffset != iSkipTrailingAsciiWhitespace ? str4.charAt(iDelimiterOffset) : (byte) -1;
                    ...
                    if (bCharAt != 64) {
                        ...
                        if (z) {
                            i = iDelimiterOffset;
                            str3 = str;
                            this.encodedPassword += "%40" + HttpUrl.canonicalize(str3, i2, i, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true, null);
                        } else {
                            int iDelimiterOffset2 = Util.delimiterOffset(str4, i2, iDelimiterOffset, ':');
                ...
                if (i4 < iDelimiterOffset) {
                    this.host = canonicalizeHost(str2, i3, iPortColonOffset);
                    int port = parsePort(str2, i4, iDelimiterOffset);
                    this.port = port;
                    if (port == -1) {
                        throw new IllegalArgumentException("Invalid URL port: \"" + str2.substring(i4, iDelimiterOffset) + Typography.quote);
                    }
                } else {
                    this.host = canonicalizeHost(str2, i3, iPortColonOffset);
                ...
                if (this.host == null) {
                    throw new IllegalArgumentException("Invalid URL host: \"" + str2.substring(i3, iPortColonOffset) + Typography.quote);
                }
    ...
    static String canonicalize(String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4, Charset charset) throws EOFException {
        int iCharCount = i;
        while (iCharCount < i2) {
    ...
    static void canonicalize(Buffer buffer, String str, int i, int i2, String str2, boolean z, boolean z2, boolean z3, boolean z4, Charset charset) throws EOFException {
        Buffer buffer2 = null;
        while (i < i2) {
            int iCodePointAt = str.codePointAt(i);
